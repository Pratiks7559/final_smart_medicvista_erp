...
class PurchaseMaster(models.Model):
    ...
    product_free_qty=models.FloatField(default=0.0, help_text="Free quantity received")
...
class SalesMaster(models.Model):
    ...
    sale_free_qty=models.FloatField(default=0.0, help_text='Free quantity given')
...
class ReturnPurchaseMaster(models.Model):
    ...
    returnproduct_free_qty=models.FloatField(default=0.0, help_text='Free quantity returned')
...
class ReturnSalesMaster(models.Model):
    ...
    return_sale_free_qty=models.FloatField(default=0.0, help_text='Free quantity returned')
...
class BatchInventoryCache(models.Model):
    ...
    current_free_qty = models.FloatField(default=0, help_text="Current free quantity in stock")
    total_stock = models.FloatField(default=0, help_text="Total stock (current_stock + current_free_qty)")
